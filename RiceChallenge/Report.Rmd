...
The above graph shows that the two types of rice are well clustered with each other, meaning that even with only two components we should not incur in many false positives or negatives