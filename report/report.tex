...
%%%% article.
\begin{abstract}
All R source code, images and \LaTeX\ sources, can be found at the following repository: \url{https://github.com/mhetacc/DataMiningChallenges/}. Datasets have been removed and can be found at \url{https://www.datachallenge.it/competitions/}.
\end{abstract}
%%
%%
%%%%
