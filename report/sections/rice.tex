...
\begin{table}
  \centering
  \caption{Correlation matrix of morphological parameters}
...
\begin{table}
  \centering
  \caption{Regression coefficients for morphological parameters}
...
The significance stars tells us that, with the exception of \textit{Minor\_Axis\_Length}, the features that are highly correlated to each other contributes strongly to the model, while the \textit{Eccentricity} and \textit{Extent} contribute very little.

We can also measure the total variance explained by all predictors combined using $R^2 = 0.6953849$.